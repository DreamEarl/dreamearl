...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  social:
    "w-full border-2 border-gray-300 text-gray-900 font-light tracking-wide hover:border-gray-400 transition-colors flex items-center justify-center gap-3",
  underline:
    "text-sm text-center text-gray-600 hover:text-gray-900 transition-colors underline",
};
