...
export const translations = {
  ...
  checkout: {
    ...
    paymentFailed: {
      ...
      message: "Your payment didn't go through. No amount has been charged.",
      retry: "Try Again",
    },
  },
  orderSuccess: {
    ...
    failed: {
      title: "Payment Failed",
      message: "We couldn't confirm your payment for this order.",
      retry: "Try Again",
    },
    orderNumber: "Order #",
  ...
  login: {
    ...
    createAccount: {
      ...
      passwordPlaceholder: "Password",
      updatesOptIn:
        "Keep me updated on new collections, limited editions and exclusive offers.",
    ...
    success: {
      forgotPassword: "Password reset email sent. Please check your inbox.",
      signUpConfirm:
  ...
  account: {
    ...
    addresses: {
      ...
      empty: "Save your address for a faster and smoother checkout experience.",
      ...
      form: {
        ...
        phonePlaceholder: "+91",
        line1: "Address Line 1*",
        line1Placeholder: "House no, Building name, Street, Area",
        line2: "Address Line 2 (Optional)",
        line2Placeholder: "Apartment, Landmark, etc",
        city: "City*",
      ...
      errors: {
        generic: "Something went wrong. Please try again.",
        loadFailed: "Unable to load your addresses. Please try again.",
      },
    },
  },
  footer: {
